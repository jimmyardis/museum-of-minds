 ...
 *         data-persona-id="george-washington-carver"></script>
 */
...
(function() {
    ...
    const PERSONA_ID = script.getAttribute('data-persona-id') || 'george-washington-carver';
    ...
    function createWidget(config) {
        ...
        container.id = 'george-washington-carver-widget';
        container.innerHTML = `
