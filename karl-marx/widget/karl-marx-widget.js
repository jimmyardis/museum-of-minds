 ...
 *
 * Usage:
 * <script src="karl-marx-widget.js"
 *         data-api-url="http://localhost:8000"
 *         data-persona-id="karl-marx"></script>
 */
...
(function() {
    ...
    const PERSONA_ID = script.getAttribute('data-persona-id') || 'karl-marx';
    ...
    async function init() {
        try {
            ...
            // Fallback to Karl Marx defaults if config fails
    ...
    // Get default config (Karl Marx fallback)
    function getDefaultConfig() {
        return {
            metadata: { name: 'Karl Marx' },
            widget: {
